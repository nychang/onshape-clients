...
export enum BlobElementsApiApiKeys {
}

export class BlobElementsApi {
    ...
    public setApiKey(key: BlobElementsApiApiKeys, value: string) {
        (this.authentications as any)[BlobElementsApiApiKeys[key]].apiKey = value;
    }
