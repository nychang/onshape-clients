...
import { BTFeatureScriptEvalCall } from '../model/bTFeatureScriptEvalCall';
import { BTFeatureScriptEvalResponse } from '../model/bTFeatureScriptEvalResponse';
...
import { BTRootDiffInfo } from '../model/bTRootDiffInfo';
...
export enum PartStudiosApiApiKeys {
}

export class PartStudiosApi {
    ...
    public setApiKey(key: PartStudiosApiApiKeys, value: string) {
        (this.authentications as any)[PartStudiosApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public comparePartStudios1 (did: string, wvm: string, wvmid: string, eid: string, workspaceId?: string, versionId?: string, microversionId?: string, sourceConfiguration?: string, targetConfiguration?: string, linkDocumentId?: string) : Promise<{ response: http.ClientResponse; body: BTRootDiffInfo;  }> {
        const localVarPath = this.basePath + '/api/partstudios/d/{did}/{wvm}/{wvmid}/e/{eid}/compare'
            .replace('{' + 'did' + '}', encodeURIComponent(String(did)))
            .replace('{' + 'wvm' + '}', encodeURIComponent(String(wvm)))
            .replace('{' + 'wvmid' + '}', encodeURIComponent(String(wvmid)))
            .replace('{' + 'eid' + '}', encodeURIComponent(String(eid)));
        ...
        if (microversionId !== undefined) {
            localVarQueryParameters['microversionId'] = ObjectSerializer.serialize(microversionId, "string");
        }

        if (sourceConfiguration !== undefined) {
            localVarQueryParameters['sourceConfiguration'] = ObjectSerializer.serialize(sourceConfiguration, "string");
        }

        if (targetConfiguration !== undefined) {
            localVarQueryParameters['targetConfiguration'] = ObjectSerializer.serialize(targetConfiguration, "string");
        }
        ...
        return new Promise<{ response: http.ClientResponse; body: BTRootDiffInfo;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
                    body = ObjectSerializer.deserialize(body, "BTRootDiffInfo");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    } else {
                        reject({ response: response, body: body });
     ...
     */
    public deleteFeature (did: string, wid: string, eid: string, fid: string) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/api/partstudios/d/{did}/w/{wid}/e/{eid}/features/featureid/{fid}'
            .replace('{' + 'did' + '}', encodeURIComponent(String(did)))
            .replace('{' + 'wid' + '}', encodeURIComponent(String(wid)))
            .replace('{' + 'eid' + '}', encodeURIComponent(String(eid)))
     ...
     */
    public evalFeatureScript (did: string, wvm: string, wvmid: string, eid: string, configuration?: string, bTFeatureScriptEvalCall?: BTFeatureScriptEvalCall) : Promise<{ response: http.ClientResponse; body: BTFeatureScriptEvalResponse;  }> {
        const localVarPath = this.basePath + '/api/partstudios/d/{did}/{wvm}/{wvmid}/e/{eid}/featurescript'
            .replace('{' + 'did' + '}', encodeURIComponent(String(did)))
            .replace('{' + 'wvm' + '}', encodeURIComponent(String(wvm)))
            .replace('{' + 'wvmid' + '}', encodeURIComponent(String(wvmid)))
            .replace('{' + 'eid' + '}', encodeURIComponent(String(eid)));
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(bTFeatureScriptEvalCall, "BTFeatureScriptEvalCall")
        };
        ...
        return new Promise<{ response: http.ClientResponse; body: BTFeatureScriptEvalResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
                    body = ObjectSerializer.deserialize(body, "BTFeatureScriptEvalResponse");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    } else {
                        reject({ response: response, body: body });
     ...
     * @param eid 
     */
    public getConfiguration4 (did: string, wvm: string, wvmid: string, eid: string) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/api/partstudios/d/{did}/{wvm}/{wvmid}/e/{eid}/configuration'
            .replace('{' + 'did' + '}', encodeURIComponent(String(did)))
            .replace('{' + 'wvm' + '}', encodeURIComponent(String(wvm)))
            .replace('{' + 'wvmid' + '}', encodeURIComponent(String(wvmid)))
            .replace('{' + 'eid' + '}', encodeURIComponent(String(eid)));
     ...
     * @param eid Element ID.
     */
    public getFeatureSpecs (did: string, wvm: string, wvmid: string, eid: string) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/api/partstudios/d/{did}/{wvm}/{wvmid}/e/{eid}/featurespecs'
            .replace('{' + 'did' + '}', encodeURIComponent(String(did)))
            .replace('{' + 'wvm' + '}', encodeURIComponent(String(wvm)))
            .replace('{' + 'wvmid' + '}', encodeURIComponent(String(wvmid)))
            .replace('{' + 'eid' + '}', encodeURIComponent(String(eid)));
     ...
     * @param body 
     */
    public updateConfiguration3 (did: string, wvm: string, wvmid: string, eid: string, body?: string) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/api/partstudios/d/{did}/{wvm}/{wvmid}/e/{eid}/configuration'
            .replace('{' + 'did' + '}', encodeURIComponent(String(did)))
            .replace('{' + 'wvm' + '}', encodeURIComponent(String(wvm)))
            .replace('{' + 'wvmid' + '}', encodeURIComponent(String(wvmid)))
     ...
     * @param body feature The serialized feature definition
     */
    public updateFeature (did: string, wid: string, eid: string, fid: string, body?: string) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/api/partstudios/d/{did}/w/{wid}/e/{eid}/features/featureid/{fid}'
            .replace('{' + 'did' + '}', encodeURIComponent(String(did)))
            .replace('{' + 'wid' + '}', encodeURIComponent(String(wid)))
            .replace('{' + 'eid' + '}', encodeURIComponent(String(eid)))
     ...
     * @param body feature The serialized feature definition
     */
    public updateFeatures1 (did: string, wid: string, eid: string, body?: string) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/api/partstudios/d/{did}/w/{wid}/e/{eid}/features/updates'
            .replace('{' + 'did' + '}', encodeURIComponent(String(did)))
            .replace('{' + 'wid' + '}', encodeURIComponent(String(wid)))
            .replace('{' + 'eid' + '}', encodeURIComponent(String(eid)));
        let localVarQueryParameters: any = {};
     ...
     */
    public updateRollback (did: string, wid: string, eid: string, body?: string) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/api/partstudios/d/{did}/w/{wid}/e/{eid}/features/rollback'
            .replace('{' + 'did' + '}', encodeURIComponent(String(did)))
            .replace('{' + 'wid' + '}', encodeURIComponent(String(wid)))
            .replace('{' + 'eid' + '}', encodeURIComponent(String(eid)));
        let localVarQueryParameters: any = {};
